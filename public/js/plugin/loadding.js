    ...
    $.fn.loading = function(options){
        ...
        return this.each(function(){
            ...
            var defaultProp = {
                ...
                discFontSize:           'inherit',
                discFontWeight:         'normal',
                discFontFamily:         'inherit',
            ...
            defaultProp._showOriginLoading = function(){
                ...
                _this.loading_title = $('<p class="loading-title txt-textOneRow"></p>').css({
                    color:opt.titleColor,fontSize:opt.titleFontSize,fontWeight:opt.titleFontWeight,fontFamily:opt.titleFontFamily
                ...
                _this.loading_discription = $('<p class="loading-discription txt-textOneRow"></p>').css({
                    color:opt.discColor,fontSize:opt.discFontSize,fontWeight:opt.discFontWeight,fontFamily:opt.discFontFamily
